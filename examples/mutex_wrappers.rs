...
fn main() {
    ...
    let decoded = <ExampleStdMutex as ProtoDecode>::decode(&encoded[..], proto_rs::encoding::DecodeContext::default())
        .expect("decode std mutex");
    ...
    #[cfg(feature = "parking_lot")]
    {
        ...
        let decoded = <ExampleParkingLotMutex as ProtoDecode>::decode(
            &encoded[..],
            proto_rs::encoding::DecodeContext::default(),
        )
        .expect("decode parking_lot mutex");
